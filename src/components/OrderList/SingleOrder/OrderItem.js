            ...
            <Table borderless>
              <thead>
                <tr>
                  ...
                  <th>Quantity</th>
                  <th>Duration</th>
                  <th className="tbl_last_head">Amount</th>
                </tr>
              </thead>
              <tr>
                <td>
                ...
                <>
                  <tr>
                    <td className="text-left modifield_order">
                      <b className="gigs_title modifield__order"> Modified Order Details </b>
                    </td>
                  </tr>
                  {resolution_data
                    ?.filter((list) => list?.type === "seller_modify_order"  && list?.approved_at != null && list?.rejected_at == null)
                    ?.map((elem) =>
