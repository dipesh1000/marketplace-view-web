...
import { sendProgressUpdate } from "../redux/Action";
import { serialize } from "object-to-formdata";

function ProgressBox({ orderId }) {
  ...
  const onSubmit = (values) => {
    ...
    dispatch(sendProgressUpdate(orderId, formData));
  };
      ...
      <CustomForm>
        ...
        <div className="btn-wrap">
          <button type="submit" className="send-btn">
            <i class="fas fa-paper-plane"></i> Deliver Progress
          </button>
        </div>
      </CustomForm>
    </div>
