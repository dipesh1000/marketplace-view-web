...
import {editProfileInfo} from "../../../../api/EditProfile/EditProfileApi";
import {returnSuccess} from "../../../../redux/Success/Success.action";
import {changeRole} from "../../../../redux/Auth/Auth.action";
...
export const updateProfileInfo = (
	...
	dispatch({
		type: actions.EDIT_ACTION_BEGIN,
	});
	editProfileInfo(data)
		.then(res => {
			dispatch({
				type: actions.EDIT_ACTION_COMPLETE,
			});
			dispatch({
				type: actions.FORM_ACTION_SAVE,
			});
...
export const profileSuccess = (handleRoute = null) => dispatch => {
