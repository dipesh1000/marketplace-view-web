...
function BuyerResolutionCancel() {
            ...
            <Row>
              <Col md={{ span: 7, offset: 1 }}>
                ...
                <div className="resolution-header-sub">
                  You can ask Seller to cancel the order.
                </div>
                <div className="cancel-container">
                  <div className="question">
                    Explain to the Seller why would you like to cancel the
                    order.
                  </div>
                  <CustomTextarea
                    name="message"
...
export default BuyerResolutionCancel;
